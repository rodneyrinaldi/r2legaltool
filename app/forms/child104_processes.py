...
from app.processing.feat104_processes import ReadTjspProcesses
...
class Processes:
    ...
    def open_pdf(self):
        ...
        if file_path:
            ReadTjspProcesses(file_path, self.update_progress, self.check_processing, self.update_status, self.processing_complete)
